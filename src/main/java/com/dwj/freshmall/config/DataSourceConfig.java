package com.dwj.freshmall.config;
...
public class DataSourceConfig {
    ...
    static final String PACKAGE = "com.dwj.freshmall.mapper";
    static final String MAPPER_LOCATION = "classpath:mapper/*.xml";
    static final String ALIAS = "com.dwj.freshmall.model";

    @Value("jdbc:mysql://127.0.0.1:3306/fresh?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=GMT")
    private String url;
